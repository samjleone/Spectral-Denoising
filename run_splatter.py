...
sig_denoised_gaussian_bandlimit_low = denoise_experiment(pygsp_graph, adata_gaussian.X, 'bandlimit_low')
sig_denoised_gaussian_bandlimit_high = denoise_experiment(pygsp_graph, adata_gaussian.X, 'bandlimit_high')
...
pd.DataFrame(sig_denoised_gaussian_bandlimit_low).to_csv(save_folder + 'denoised_gaussian_bandlimit_low.csv', index=False)
pd.DataFrame(sig_denoised_gaussian_bandlimit_high).to_csv(save_folder + 'denoised_gaussian_bandlimit_high.csv', index=False)
...
sig_denoised_bernoulli_bandlimit_low = denoise_experiment(pygsp_graph, adata_bernoulli.X, 'bandlimit_low')
sig_denoised_bernoulli_bandlimit_high = denoise_experiment(pygsp_graph, adata_bernoulli.X, 'bandlimit_high')
magic_op = magic.MAGIC()
...
pd.DataFrame(sig_denoised_bernoulli_bandlimit_low).to_csv(save_folder + 'denoised_bernoulli_bandlimit_low.csv', index=False)
pd.DataFrame(sig_denoised_bernoulli_bandlimit_high).to_csv(save_folder + 'denoised_bernoulli_bandlimit_high.csv', index=False)
...
sig_denoised_uniform_bandlimit_low = denoise_experiment(pygsp_graph, adata_uniform.X, 'bandlimit_low')
sig_denoised_uniform_bandlimit_high = denoise_experiment(pygsp_graph, adata_uniform.X, 'bandlimit_high')
magic_op = magic.MAGIC()
...
pd.DataFrame(sig_denoised_uniform_bandlimit_low).to_csv(save_folder + 'denoised_uniform_bandlimit_low.csv', index=False)
pd.DataFrame(sig_denoised_uniform_bandlimit_high).to_csv(save_folder + 'denoised_uniform_bandlimit_high.csv', index=False)
